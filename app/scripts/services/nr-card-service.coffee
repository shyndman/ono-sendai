...
class CardService
  ...
  constructor: ($http, @$log, @imageService, @searchService, @filterDescriptors, @QueryResult) ->
    @_cards = []
    @_sets = []
    @_setsByTitle = {}
    @_setsById = {}
...
angular.module('onoSendai')
  ...
  .service('cardService', ($http, $log, imageService, searchService, filterDescriptors, QueryResult) ->
